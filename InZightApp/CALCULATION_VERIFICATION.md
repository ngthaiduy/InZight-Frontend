...
### Step 2: Future Value of Monthly Contributions (SIMPLE)
```
...
### Step 5: Total Needed (20 years, with inflation and discounting)
```
For each year i from 0 to 19:
  Expense in year i = 236,364,408 × (1.03)^i
  Discounted value = Expense / (1.05)^i
  Total Needed += Discounted value

Year 0: 236,364,408 / 1.05^0 = 236,364,408
Year 1: 243,457,340 / 1.05^1 = 231,864,133
Year 2: 250,761,060 / 1.05^2 = 227,447,220
...
Total Needed ≈ 4,727,520,000 VND (approximate)
```
...
## Expected Output:
- futureValue: 3,911,601,500 VND
- sustainableYears: ~16 years
- monthlySavingsNeeded: ~465,000 VND
- retirementGap: 815,918,500 VND
- totalNeeded: ~4,727,520,000 VND
